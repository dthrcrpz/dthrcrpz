<div class="fixed top-0 left-0 bottom-0 right-0 m-auto w-full h-full z-50 bg-black bg-opacity-50 flex justify-center items-start px-5" on:click|self={close}>
